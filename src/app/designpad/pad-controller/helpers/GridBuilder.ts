...
export class GridBuilder {
  ...
  public static drawSelectiveElementsLayout(elements: BasicState[], canvasWidth: number, canvasHeight: number, startPosition: Point, pad: P5, drawLevel: number, cameraPosition: Triple) {
    const padding = 5;
